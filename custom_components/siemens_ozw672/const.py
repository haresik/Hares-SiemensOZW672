...
DEFAULT_PREFIX_FUNCTION = False  # Skryto v UI, vždy False
DEFAULT_PREFIX_OPLINE = True
DEFAULT_PREFIX_DEVICE = False
...
DEFAULT_OPTIONS = {'httptimeout': DEFAULT_HTTPTIMEOUT, 
    ...
    CONF_PREFIX_DEVICE: DEFAULT_PREFIX_DEVICE, 
